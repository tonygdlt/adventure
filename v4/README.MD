...
v1.25 Aug 14th - Add upstairs window to front yard. Add description about family to picture. Add dining room and related objects. Add loading items from files<br>